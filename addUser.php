...
<?php include 'nav.php'; ?>
    ...
    <h1 class="text-primary text-center fw-bold mt-4">Add New User Form</h1>
	...
	<form method="post" action="addUser.php">
		...
		<button type="submit" class ="btn btn-primary fs-5" value="Register" id="register">Add New User</button>	
	</form><br>
