...
<?php endif ?>
    ...
    <div class="container border border-2 rounded-5 border-danger mt-5 shadow-lg px-3">
        <h2   class="text-center  text-danger fw-bold mt-4">Update Category</h2>
    ...
    <!-- Remember that alternative syntax is good and html inside php is bad -->
            ...
            <form method="post">
                ...
                <button type="submit" value="update" class="btn btn-danger fs-5" id="update" name="update">Update</button><br>
